...
def train_models(data):
    ...
    logging.info("Defining Classifiers")
    # Define classifiers
    classifiers = {
    ...
    logging.info("Performing Stratified-K-Fold")
    # Perform stratified k-fold cross-validation
    skf = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)

    # Evaluate classifiers and save results
    results = {}
    logging.info("Training Classifiers and Collecting Results")
    ...
    logging.info("Dumping results and returning")
